...
Characteristic.prototype.StartNotify = function StartNotify() {
    var cb = this.options.StartNotify ? this.options.StartNotify.bind(this.options) : function() {};
    cb();
...
Characteristic.prototype.StopNotify = function StopNotify() {
    var cb = this.options.StopNotify ? this.options.StopNotify.bind(this.options) : function() {};
    cb();
